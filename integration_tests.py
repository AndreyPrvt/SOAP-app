...
class IntegrationTests(unittest.TestCase):
    ...
    def test_read_all(self):
        self.assertEqual(read_all(), ["<Document u'16f98a5c35dcb61ce73f486390005be5'@u'2-314ae555d881c79e88a21d4df5230f72' {u'surname': u'fg', u'name': u'gf'}>",
...
"<Document u'16f98a5c35dcb61ce73f486390006dc9'@u'1-61c91e79536b7c0562503ca084c912b8' {u'surname': u'we', u'name': u'we'}>]"])
    ...
    def test_read(self):
        self.assertEqual(read(0), "<Document u'16f98a5c35dcb61ce73f486390005be5'@u'2-314ae555d881c79e88a21d4df5230f72' {u'surname': u'fg', u'name': u'gf'}>")
